...
API_BASE_URL = "https://great-glowworm-gently.ngrok-free.app/api"
...
#     doc = mongo_collection.find_one({"conversation_id": chat_id})
#     if doc and "key_ideas" in doc:
#         return doc["key_ideas"]
#     return ""

# def delete_memory(chat_id):
#     result = mongo_collection.delete_many({"conversation_id": chat_id})
